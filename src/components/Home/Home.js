...
// useLocation to know which page I'm currently on
// useHistory to renavigate to search pages
...
const Home = () => {
    ...
    const searchPost = () => {
        if (search.trim() || tags ) {
            // dispatch some logic to fetch search post
            ...
            <Container maxWidth="xl">
                <Grid container justifyContent="space-between" alignItems="stretch" spacing={3} className={ classes.gridContainer }>
                    ...
                    <Grid item xs={12} sm={6} md={3}>
                        ...
                        <Paper elevation={6}>
                            {/* we are going to directly pass page as props */}
